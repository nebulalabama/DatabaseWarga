...
@section('title', 'Tambah RW - Dbwarga')

@section('content')
<div class="max-w-md mx-auto">
    <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        <h1 class="mb-6 text-2xl font-bold text-center">Tambah RW</h1>

        <form action="{{ route('community_units.store') }}" method="POST">
            @csrf
            @method('POST')
            <div class="mb-4">
                ...
                <div class="flex items-center border rounded-md">
                    ...
                    <input class="w-full px-4 py-2 outline-none" id="no_rw" name="no_rw" type="text" placeholder="contoh: 001, 005,...">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center border rounded-md">
                    ...
                    <input class="w-full px-4 py-2 outline-none" id="head" name="head" type="text" placeholder="Nama Ketua RW">
                </div>
            </div>
