            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-black capitalize dark:text-white">{{ Auth::user()->name ?? 'Username' }}</span>
                        <span class="block text-xs font-medium">{{ Auth::user()->role ?? 'pengguna' }}</span>
                    </span>

                    <span class="w-8 h-8 rounded-full">
                        <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name ?? 'username' }}&background=random" alt="User" class="rounded-full" />
                    </span>
                ...
                <div x-show="dropdownOpen"
                    class="absolute right-0 mt-4 flex w-62.5 flex-col rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
