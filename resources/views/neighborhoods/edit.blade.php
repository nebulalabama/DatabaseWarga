...
@section('title', 'Ubah RT - Dbwarga')

@section('content')
<div class="max-w-md mx-auto">
    <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        <h1 class="mb-6 text-2xl font-bold text-center">Ubah RT</h1>

        <form action="{{ route('neighborhoods.update', $neighborhoods->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                ...
                <div class="flex items-center border rounded-md">
                    ...
                    <input class="w-full px-4 py-2 outline-none dark:bg-meta-4" value="{{ $neighborhoods->name }}" id="no_rt" name="no_rt" type="text" placeholder="contoh: 001, 005,...">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center border rounded-md">
                    ...
                    <input class="w-full px-4 py-2 outline-none dark:bg-meta-4" value="{{ $neighborhoods->head }}" id="head" name="head" type="text" placeholder="Nama Ketua RT">
                </div>
            </div>
            ...
            <div class="flex justify-center gap-5 py-3">
                <div class="mb-4">
                    <button type="submit" class="inline-flex items-center px-4 py-2 font-bold text-white bg-red-500 border-b-4 border-red-700 rounded hover:bg-red-400 hover:border-red-500">
                        <span>Kembali</span>
                    </button>
                </div>
                <div class="mb-4">
