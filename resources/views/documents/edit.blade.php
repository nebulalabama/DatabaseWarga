...
@section('title', 'Edit Dokumen - Dbwarga')
                        ...
                        <form action="{{ route('documents.update', ['id'=>$document->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label class="mb-2.5 block font-medium text-black dark:text-white">Nomor Induk
                                    Kependudukan</label>
                                <div class="relative">
                                    <input value="{{$document->resident_id}}" id="resident_id" name="resident_id" type="number" required
                            ...
                            <div class="mb-6">
                                ...
                                <input value="{{$document->ktp}}" type="file" name="ktp" id="ktp"
                                ...
                                <h1 class="text-sm mt-2 text-slate-500">File saat ini: {{$document->ktp}}</h1>
                            </div>

                            <div class="mb-6">
                                <label class="block font-medium text-black dark:text-white">Unggah KK</label>
                                <input value="{{$document->kk}}" type="file" name="kk" id="kk"
                                    class="block w-full mt-2 text-sm text-slate-500
                                    file:mr-4 file:py-2 file:px-4
                                    file:rounded-full file:border-0
                                    file:text-sm file:font-semibold
                                    file:bg-blue-50 file:text-blue-700
                                    hover:file:bg-blue-100" />
                                    <h1 class="text-sm mt-2 text-slate-500">File saat ini: {{$document->kk}}</h1>
                            </div>

                            <div class="mb-6">
                                <label class="block font-medium text-black dark:text-white">Unggah Akta Lahir</label>
                                <input value="{{$document->akta_lahir}}" type="file" name="akta_lahir" id="akta_lahir"
                                    class="block w-full mt-2 text-sm text-slate-500
                                    file:mr-4 file:py-2 file:px-4
                                    file:rounded-full file:border-0
                                    file:text-sm file:font-semibold
                                    file:bg-blue-50 file:text-blue-700
                                    hover:file:bg-blue-100" />
                                    <h1 class="text-sm mt-2 text-slate-500">File saat ini: {{$document->akta_lahir}}</h1>
                            </div>

                            <div class="mb-6">
                                <label class="block font-medium text-black dark:text-white">Unggah Paspor</label>
                                <input value="{{$document->paspor}}" type="file" name="paspor" id="paspor"
                                    class="block w-full mt-2 text-sm text-slate-500
                                    file:mr-4 file:py-2 file:px-4
                                    file:rounded-full file:border-0
                                    file:text-sm file:font-semibold
                                    file:bg-blue-50 file:text-blue-700
                                    hover:file:bg-blue-100" />
                                    <h1 class="text-sm mt-2 text-slate-500">File saat ini: {{$document->paspor}}</h1>
                            </div>
